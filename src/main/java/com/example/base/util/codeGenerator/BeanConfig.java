...
package com.example.base.util.codeGenerator;
...
public class BeanConfig {
    ...
    private static final String REAL_PATH = "G:\\Practise\\SpringBoot_JPA\\ssh\\src\\main\\java\\";
    ...
    private static final String ANNOTATION_DESCRIPTION = "@description 这些实现类必须加 @Repository 否则回报没有注入bean";
    ...
    private static final String BASE_CONTROLLER_NAME = BASE_PATH + "com.example.base.controller.BaseController";
    private static final String BASE_DAO_NAME = BASE_PATH + "com.example.base.repository.BaseRepository";
    private static final String BASE_DAO_IMPL_NAME = BASE_PATH + "com.example.base.repository.BaseRepositoryImpl";
    private static final String BASE_SERVICE_NAME = BASE_PATH + "com.example.base.service.BaseService";
    private static final String BASE_SERVICE_IMPL_NAME = BASE_PATH + "com.example.base.service.BaseServiceImpl";
